...
COMMAND:
    ...
    -h, help        run \`$ conductor [command] -h\` for more information about a specific command
    -v, version     outputs current package version
...
SUBCOMMAND:
    -r      refresh current repository list
...
const versionHelp = (version) => { console.log(version) };
const helpType = {
    GENERAL: 'help',
    LIST: 'list',
    PULL: 'pull',
